...
const Checkout = () => {
  return (
    <div className="flex w-[screen] h-fit px-28 py-2">
      <div className="w-full h-full">
        <div className="flex justify-start items-start h-fit m-2 p-6">
          <h1 className="text-[48px]">Checkout</h1>
        </div>
        <div className="flex gap-2 w-8/12 h-fit p-2 border-b-2 border-[#c9c9c9]">
        ...
        <div className="flex">
          <div className="flex flex-col gap-2 w-8/12 h-fit m-2 ml-0">
            {Array(5)
              .fill(null)
              .map((_, index) => (
                <div
                  key={index}
                  className="flex items-center justify-center gap-2 w-full h-fit m-2 p-2 ml-0 border-b-2 border-[#c9c9c9]"
                >
                  <div className="flex w-5/12 h-fit text-[24px] m-2">
                    ...
                    <div className="flex flex-col text-[24px] overflow-hidden">
                      ...
                      <div className="text-[14px] pl-8 font-[10px">Size: S</div>
                    </div>
                  </div>
                  ...
                  <div className="w-2/12 h-fit text-[24px] text-center">
                    <div className="flex justify-center items-center gap-6 border-2 border-black rounded-lg p-1">
          ...
          <div className="relative left-10 top-10 flex flex-col gap-2 w-4/12 h-fit m-2 p-2 ml-0 border border-[#c9c9c9] rounded">
            <div className="flex justify-between w-full h-fit p-2 border-b-2 border-[#c9c9c9] text-[24px] font-bold">
            ...
            <div className="flex justify-between w-full h-fit p-2 px-6 border-b-2 border-[#c9c9c9] text-[16px] font-medium">
              <div className="">Shiipping</div>
              <div className="">₹ 0</div>
            </div>

            <div className="flex justify-between w-full h-fit p-2 px-6 text-[24px] font-bold">
